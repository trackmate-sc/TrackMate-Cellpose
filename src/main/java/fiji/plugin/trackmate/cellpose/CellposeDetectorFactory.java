...
public class CellposeDetectorFactory< T extends RealType< T > & NativeType< T > > implements SpotGlobalDetectorFactory< T >
{
	...
	public static final String INFO_TEXT = "<html>"
			...
			+ "<a http=\"https://github.com/MouseLand/cellpose#local-installation\">https://github.com/MouseLand/cellpose#local-installation</a>"
			+ "<p>"
			...
			+ "also cite the Cellpose paper: <i>Stringer, C., Wang, T., Michaelos, M. et al. "
			+ "Cellpose: a generalist algorithm for cellular segmentation. "
			+ "Nat Methods 18, 100–106 (2021)</i>"
			+ "</html>";
